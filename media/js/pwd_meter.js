...
**    Adaptaciones: Centro Nacional de Desarrollo e Investigación en Tecnologías Libres (CENDITEL)
**					Dirección de Desarrollo
**					T.S.U. Roldan D. Vargas G.
**	  Última modificación: 2009-10-15
**
**    License Information:
**    -------------------------------------------------------------------------
...
function chkPass(pwd) {
	...
	/* Modify overall score value based on usage vs requirements */
		...
		document.getElementById('fortaleza').value = meter;
	}
	else {
		...
		oScore.innerHTML = nScore + "%";
		oComplexity.innerHTML = sComplexity;
		document.getElementById('complexity').innerHTML = "muy corta";
	}
}

function togPwdMask() {
	var oPwd = document.getElementById("contrasenha");
}

function initPwdChk(restart) {
	if (restart) {
		document.getElementById("contrasenha").className = "";
	}
}
